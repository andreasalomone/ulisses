...
export function ScenarioCard({
    ...
    return (
        <Card className={cn("group flex flex-col h-full bg-card hover:shadow-lg transition-all duration-300", className)}>
            <CardHeader>
                <CardTitle className="text-2xl font-bold group-hover:text-primary transition-colors">
                    {title}
                </CardTitle>
                <CardDescription className="text-muted-foreground/80 leading-relaxed mt-2">
                    {description}
                </CardDescription>
            </CardHeader>
