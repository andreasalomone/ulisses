...
export function FeaturedStory() {
    const t = useTranslations('ferroviario.featuredStory');
    const tA11y = useTranslations('accessibility');

    // Optional: check if translation exists or just render.
    // Usually t() returns key if missing. We assume it exists.
